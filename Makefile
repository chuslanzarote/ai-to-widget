...
#   into demo/atw-aurelia/.atw/artifacts/action-executors.json; stage it
...
stage-widget:
	...
	@if [ -f demo/atw-aurelia/.atw/artifacts/action-executors.json ]; then \
	  cp demo/atw-aurelia/.atw/artifacts/action-executors.json demo/medusa/storefront/public/action-executors.json; \
