 ...
 */
export function computeCostVariancePct(actualCostUsd, estimatedCostUsd) {
    if (!Number.isFinite(actualCostUsd) || !Number.isFinite(estimatedCostUsd))
        return 0;
    if (estimatedCostUsd <= 0)
        return 0;
    return ((actualCostUsd - estimatedCostUsd) / estimatedCostUsd) * 100;
}
//# sourceMappingURL=cost-variance.js.map