...
export class ConfigError extends Error {
    missing;
    constructor(missing) {
        super(`atw-backend: missing required environment variables: ${missing.join(", ")}. See specs/003-runtime/contracts/chat-endpoint.md §9.`);
...
import { ProjectConfigSchema, checkProjectConfigInvariants, } from "./schemas/project-md.js";
...
export function loadProjectConfig(opts = {}) {
    ...
    if (invariantIssues.length > 0) {
        throw new ProjectConfigError("project.md frontmatter failed cross-field invariants", invariantIssues);
    }
    return cfg;
}
